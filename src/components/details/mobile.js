...
import Num from '../common/number/mobile';
	...
	render(){
		...
		return (
			<div className="details">
				...
				<div className="details-content">
					{
						detailData.goods_info ? (
							<div className="details-info">
								...
								<p>单笔消费满196元，运费立减20元</p>

								<a onClick={this.handleLike.bind(this,this.state.params.goods_id)} href="javascript:;" className="vertical-middle"><em><i className={(detailData.goods_info.is_like) ? "icon-liked" : "icon-like"}></i><br/>{detailData.goods_info.goods_like_num}人已收藏</em></a>
							</div>
						) : null
					}
				...
				<CartFixed state={this.props.state} data={{btn:"放入购物车"}} handleClick={this.handleSubmit.bind(this)} />
			</div>
		)
	}
}
